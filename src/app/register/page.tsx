  ...
  return (
    <div className="relative w-full h-[100vh] bg-gray-200 overflow-hidden">
      ...
      <div className="absolute top-[140px] left-0">
        <img src="/images/img_ellipse_4.png" alt="" className="w-[247px] h-[240px] rounded-[120px]" />
      </div>
      <div className="absolute top-[600px] right-[13px]">
        <img src="/images/img_ellipse_5.png" alt="" className="w-[360px] h-[360px] rounded-[180px]" />
      </div>
      <div className="absolute top-[95px] right-[12px]">
        <img src="/images/img_vector.png" alt="" className="w-[387px] h-[340px]" />
      </div>
      <div className="absolute top-[561px] left-0">
        <img src="/images/img_vector_463x463.png" alt="" className="w-[463px] h-[463px]" />
      </div>
      ...
      >
        <img src="/images/img_tennda_png_2.png" alt="Tennda Logo" className="h-[180px] w-auto object-contain mt-[80px]" />
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full px-16 mb-2">
          <div className="flex items-center">
            <img src="/images/img_4211112_2.png" alt="" className="w-[75px] h-[75px]" />
